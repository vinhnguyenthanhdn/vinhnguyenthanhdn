...
- **[ai-crypto](https://github.com/vinhnguyenthanhdn/ai-crypto)** — a research platform for discovering and rigorously *falsifying* crypto trading strategies. 29,373 configurations searched, zero promoted. It publishes the machinery that reached that verdict and the evidence that the verdict is trustworthy.
- **[claude-jobs](https://github.com/vinhnguyenthanhdn/claude-jobs)** — scheduled, unattended Claude Code CLI runs on your existing subscription, no API key. The wrapper details that decide whether a 3am job succeeds or fails silently.
...
AWS Certified Generative AI Developer – Professional (2026) · PMP (2024)
